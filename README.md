...
* **Я перешел в Slack школы, но меня не добавило в канал нового потока. Что делать?** - по умолчанию всех новых пользователей Slack-пространства школы бот добавляет в канал нового потока. Если вы уже были в Slack школы или если бот по какой-то причине не сработал, вы можете сами попасть в канал будущего потока. В Desktop-версии Slack нажать Channels -> Manage -> Browse Channels и в поиске ввести 2025 - должен найтись канал #qa_automation_2025_spring (название канала актуально на момент редактирования документа). Нажмите Join - всё, вы в нужном канале
  * <img src="https://github.com/user-attachments/assets/ef3bf4f0-a0c5-4db6-9d8a-1a64b7b9ac0f" alt="2796" width="200"/>
